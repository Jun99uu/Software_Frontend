...
//    public void drawBackground(@NonNull Canvas canvas, @NonNull Paint paint, int left, int top, int right, int bottom, int i4, @NonNull CharSequence charSequence, int i5, int i6, int i7) {
//      Rect rect = new Rect();
